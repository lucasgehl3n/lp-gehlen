<template>
    ...
    <section class="bg-gray-900">
        <div class="gap-8 items-center px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 xl:gap-16 lg:px-6 ">
                ...
                <div class="grid gap-6 lg:grid-cols-1 border-gray-700 sm:grid-cols-2">
                    <div class="flex">
                        <div class="mr-4 shrink-0">
                            <svg class="w-8 h-8 text-primary-600 text-primary-500" fill="currentColor"
            ...
            <!-- Illustration -->
            <img class="hidden mx-auto mb-4 sm:flex rounded-md max-w-2xl max-h-fit" src="~/assets/images/bicycle.webp" loading="lazy"
                alt="Imagem de homem mexendo no computador nas bordas de um lago">
        </div>
    </section>
</template>