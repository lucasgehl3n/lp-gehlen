        ...
        <div
                ...
                <Carousel id="gallery" :items-to-show="1" v-model="currentSlide" :wrap-around="true">
                    <Slide v-for="slide in pictures" :key="slide">
                        <div class="carousel__item">
                            <img :src="slide.src" class="h-full max-h-96 w-auto" v-on:click="showGalleryImage" loading="lazy" :alt="$t('altPelosCaminhos')" />
                        </div>
                    </Slide>
                    <template #addons>
                        <Navigation />
            ...
            <div class="mt-4 md:mt-0">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white">
                    {{ $t('titlePelosCaminhos') }}
                </h2>
                <p class="mb-6 font-light md:text-lg text-gray-400">
                    {{ $t('descriptionPelosCaminhos1') }}
                </p>
                <p class="mb-6 font-light md:text-lg text-gray-400">
                    {{ $t('descriptionPelosCaminhos2') }}
                </p>
                <p class="mb-6 font-light md:text-lg text-gray-400">
                    {{ $t('descriptionPelosCaminhos3') }}
                </p>
