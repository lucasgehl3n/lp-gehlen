        ...
        <div
                ...
                <Carousel id="gallery" :items-to-show="1" v-model="currentSlide" :wrap-around="true">
                    <Slide v-for="slide in pictures" :key="slide">
                        <div class="carousel__item">
                            <img :src="slide.src" class="h-full max-h-96 w-auto" v-on:click="showGalleryImage" loading="lazy" alt="Imagens do projeto Pelos Caminhos"/>
                        </div>
                    </Slide>
                    <template #addons>
                        <Navigation />
            ...
            <div class="mt-4 md:mt-0">
                ...
                <p class="mb-6 font-light md:text-lg text-gray-400">
                    O "Pelos Caminhos" é um projeto apresentado como Trabalho de Conclusão de Curso no Curso de Ciência
                    da
                    Computação na Universidade de Caxias do Sul (UCS).
                </p>
                <p class="mb-6 font-light md:text-lg text-gray-400">
                ...
                <p class="mb-6 font-light md:text-lg text-gray-400">
                    ...
                    Você pode
                    conferir mais detalhes através do artigo científico.
                </p>
                <button @click="showArticle"
                    class="mobile-text-center-button inline-flex items-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:ring-primary-900">
                    Ler artigo
                ...
                <button v-on:click="showGalleryImageArchitecture"
...
const showGalleryArchitecture = ref(false);

const showGalleryImage = (index) => {
    showGallery.value = true;
};

const showGalleryImageArchitecture = (index) => {
    showGalleryArchitecture.value = true;
};
...
const closeGalleryArchitecture = () => {
    showGalleryArchitecture.value = false;
};

const showArticle = () => {
    window.open(
        'https://drive.google.com/file/d/1wGspejLclOVXlhErvAr8gK0-ASYVHKiR/view?usp=sharing',
        '_blank'
    );
};
