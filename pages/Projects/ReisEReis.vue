        ...
        <div class="gap-4 items-center py-4 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-4 lg:px-6">
                ...
                <Carousel id="gallery" :items-to-show="1" v-model="currentSlide" :wrap-around="true">
                    <Slide v-for="slide in pictures" :key="slide.src">
                        <div class="carousel__item">
                            <img :src="slide.src" class="h-full max-h-96 w-auto" v-on:click="showGalleryImage" loading="lazy" alt="Imagens do projeto Reis e Reis"/>
                        </div>
                    </Slide>
                    <template #addons>
                        <Navigation />
            ...
            <div class="mt-4 md:mt-0">
                ...
                <p class="mb-6 font-light md:text-lg text-gray-400">
                    {{ $t('descriptionReisEReisPart1') }}
                </p>
                <p class="mb-6 font-light md:text-lg text-gray-400">
                    {{ $t('descriptionReisEReisPart2') }}
                </p>
